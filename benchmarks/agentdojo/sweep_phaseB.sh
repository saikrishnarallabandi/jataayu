...
#   nohup bash benchmarks/agentdojo/sweep_phaseB.sh > runs/agentdojo/sweep_phaseB.log 2>&1 &
set -uo pipefail
...
for suite in $SUITES; do
  OUT="$REPO/benchmarks/results/agentdojo_${suite}_qwen35b_sweep.json"
...
notify "[jataayu] Phase B sweep done ($MIN_STATUS): $SUITES. Results in benchmarks/results/agentdojo_<suite>_qwen35b_sweep.json."
