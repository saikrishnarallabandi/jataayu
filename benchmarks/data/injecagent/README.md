...
The Tier-3 effect-boundary evaluation (`benchmarks/run_effect_boundary_injecagent.py`,
results in `benchmarks/results/effect_boundary_injecagent.json`) replays the public
...
cp InjecAgent/data/test_cases_*.json benchmarks/data/injecagent/
```
...
```bash
python benchmarks/run_effect_boundary_injecagent.py        # defaults to this dir
# or: python benchmarks/run_effect_boundary_injecagent.py --data-dir <path>
```
