...
individually-plausible skill SETS (eval/data/composition_v1.jsonl). Measures whether
...
Run:
    python3 eval/run_composition_bench.py
Writes:
    eval/results/composition_v1.json
"""
