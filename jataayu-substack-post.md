...
draft = "Alice just started kindergarten at Lincoln Elementary!"
...
draft = "Alice just started at Lincoln Elementary. She's 3 years old."
result = guard.check(draft, surface="whatsapp-group")

print(result.blocked)      # True
print(result.explanation)  # "Contains protected names: Alice"
```
...
Jataayu runs as a plugin in [gateway](https://gateway.dev), exposed as two first-class tools the agent can call:
