 ...
 *   H    ABSOLUTE PATHS IN A DM are rewritten, not dropped: /home/user/projects/x/y.py
...
const DEFAULTS = {
  memDir: "/home/user/.gateway/workspace/memory",
 ...
 *   /home/user/projects/project_ascent/scripts/apply.py  ->  ~/projects/project_ascent/scripts/apply.py
  ...
  activate(api) {
    ...
    api.on("message_sending", async (event, _ctx) => {
      try {
        ...
        //   /home/user/projects/x/y.py -> ~/projects/x/y.py
