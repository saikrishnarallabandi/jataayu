/**
 * dm-guard unit tests — run with:  node /home/user/.gateway/plugins/dm-guard/test.js
 *
...
(async () => {
  ...
  {
    const g = makeGuard();
    const MP3 = "/home/user/podcasts/mem1_learning_memory_reasoning_ep24_2026-07-11.mp3";
...

  {
    const g = makeGuard();
    const r = await g.send(SAI_DM,
      "Fixed the verify hang: /home/user/projects/project_ascent/scripts/apply.py and " +
      "/home/user/.gateway/plugins/jataayu/index.js. Tests 242 green.");
  ...
  {
    const g = makeGuard();
    const r = await g.send(GROUP, "See /home/user/projects/project_ascent/README.md");
