...
childProcess.execFile = (bin, args, opts, cb) => {
  ...
  const blocked = script.includes("/home/user/.gateway/workspace/project_agent_guardrail_drift") ||
    script.includes("/home/user/projects/project_agent_guardrail_drift") ||
...
(async () => {
  try {
    const raw = "Fix lives at /home/user/.gateway/workspace/project_agent_guardrail_drift/index.js for Sai Krishna.";
    ...
    const result = await send({
      ...
      content: "Done: /home/user/projects/project_agent_guardrail_drift is patched.",
    });
