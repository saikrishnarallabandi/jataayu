...
childProcess.execFile = (bin, args, opts, cb) => {
  ...
  const blocked = script.includes("/home/srallaba/.gateway/workspace/project_agent_guardrail_drift") ||
...
(async () => {
  try {
    const raw = "Fix lives at /home/srallaba/.gateway/workspace/project_agent_guardrail_drift/index.js for Sai Krishna.";
