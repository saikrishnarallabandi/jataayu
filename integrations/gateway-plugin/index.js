...
function scrubOutboundText(text, protectedNames = []) {
  ...
  out = replaceToken(out, /\b(?:https?:\/\/github\.com\/saikrishnarallabandi\/orchestrator_memories|git@github\.com:saikrishnarallabandi\/orchestrator_memories)(?:[^\s'"`)]*)?/gi, "[internal repo]", hits, "internal-repo-url");
