...
cost (Table~\ref{tab:4suite}). A separate reproducibility note documents a silent tool-call parse
failure in AgentDojo's local-model adapter that zeroes benchmark utility; we release the fix.
