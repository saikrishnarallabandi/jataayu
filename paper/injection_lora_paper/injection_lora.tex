...
\begin{abstract}
Prompt-injection detectors are widely reported at $>$99\% recall, yet those numbers are almost
always measured \emph{in-distribution} on the detector's own dataset. We ask whether they survive a
...
recall~\citep{protectai}, and Meta's Prompt-Guard reports AUC $>$0.99~\citep{promptguard}.
